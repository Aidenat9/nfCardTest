...
package com.nfctest.nfc.nfc.bean;
            ...
            if (balance != null) {
                ...
                if (balance.isNaN()) {
                    ...
                    formatProperty(out, SPEC.TAG_LAB, app.getProperty(SPEC.PROP.CURRENCY)
                            .toString());
                    Log.e(TAG, "电子现金: " + String.format("%.2f ", balance) + app.getProperty(SPEC.PROP.CURRENCY)
                            .toString());
                }
                newline(out);
            }
...

        {
            ...
            if (balance != null) {
                ...
                if (balance.isNaN()) {
                    ...
                    formatProperty(out, SPEC.TAG_LAB, app.getProperty(SPEC.PROP.CURRENCY)
                            .toString());
                    Log.e(TAG, "余额: " + String.format("%.2f ", balance) + app.getProperty(SPEC.PROP.CURRENCY)
                            .toString());
                }
                newline(out);
            }
